	...
	t.prototype = {
		...
		addControl: function() {
			var n = this.opts,
				...
				o = n.showPanorama,
				i = a.length > 0 ? 40 : 20;
			if (t.addControl(new BMap.NavigationControl), t.addControl(new BMap.ScaleControl), t.addControl(
					new BMap.OverviewMapControl), e && t.enableScrollWheelZoom(!0), o) {
		...
		renderMarker: function() {
			...
			o.length > 0 && n.each(o, function(n, o) {
				...
				})), e.addOverlay(c), r && c.setAnimation(BMAP_ANIMATION_DROP), l && t.renderLabel(
					o), n === a.index && t.openInfoWindow(o.id), c.addEventListener("click",
					function() {
		...
		openInfoWindow: function(t) {
			...
			}), s && (c = '<div class="' + o.titleClass + '">' + i.title +
				'<img class="open-panorama-btn" src="img/panorama.png" style="margin-left:12px;cursor:pointer;vertical-align:sub;" title="查看全景" /></div>'
				);
